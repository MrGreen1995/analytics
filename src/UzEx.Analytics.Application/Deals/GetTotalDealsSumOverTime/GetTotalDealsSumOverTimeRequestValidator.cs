...
public sealed class GetTotalDealsSumOverTimeRequestValidator : AbstractValidator<GetTotalDealsSumOverTimeRequest>
{
    public GetTotalDealsSumOverTimeRequestValidator()
    {
