...
public sealed class GetRevenueByPlatformOverTimeRequestValidator
    : AbstractValidator<GetRevenueByPlatformOverTimeRequest>
{
    public GetRevenueByPlatformOverTimeRequestValidator()
    {
