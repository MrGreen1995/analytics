...
public sealed class GetRevenueByContractTypeOverTimeRequestValidator
    : AbstractValidator<GetRevenueByContractTypeOverTimeRequest>
{
    public GetRevenueByContractTypeOverTimeRequestValidator()
    {
