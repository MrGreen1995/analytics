...
public sealed class GetBrokersLastOrdersOverTimeRequestValidator
    : AbstractValidator<GetBrokersLastOrdersOverTimeRequest>
{
    public GetBrokersLastOrdersOverTimeRequestValidator()
    {
        RuleFor(x => x.Id)
