...
public sealed class GetMostActiveBrokersByRegionOverTimeRequestValidator
    : AbstractValidator<GetMostActiveBrokersByRegionOverTimeRequest>
{
    public GetMostActiveBrokersByRegionOverTimeRequestValidator()
    {
