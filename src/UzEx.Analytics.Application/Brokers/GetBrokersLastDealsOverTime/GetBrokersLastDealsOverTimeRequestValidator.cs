...
public sealed class GetBrokersLastDealsOverTimeRequestValidator
    : AbstractValidator<GetBrokersLastDealsOverTimeRequest>
{
    public GetBrokersLastDealsOverTimeRequestValidator()
    {
        RuleFor(x => x.Id)
